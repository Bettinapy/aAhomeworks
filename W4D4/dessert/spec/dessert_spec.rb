...
describe Dessert do
  let(:chef) { double("chef", name:"Bettina") }
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["sugar","salt","cream","mongo"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Bettina sthe Great Baker")
      expect(cake.serve).to eq("Chef Bettina sthe Great Baker has made 50 cakes!")
    end
  end
